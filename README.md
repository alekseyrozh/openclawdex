...
Desktop UI for orchestrating Claude and Codex coding agents through their CLIs. Think of it as a multi-agent version of the Codex desktop app with a native Mac feel.
