...
function createWindow() {
  ...
  // - `img-src 'self' data: blob: https:` — assistant markdown can
  //   include remote images; the composer also renders `blob:` object
  //   URLs for dragged/pasted image previews and `data:` URLs for
  //   inline screenshots.
